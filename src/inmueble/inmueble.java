...
public abstract class inmueble {
    ...
    public static final void poblar() {
        precios_area.put("Casa rural", 1500000.0);
        precios_area.put("Casa en conjunto cerrado", 2500000.0);
        precios_area.put("Casa independiente", 3000000.0);
        precios_area.put("Apartaestudio", 1500000.0);
        precios_area.put("Apartamento familiar", 2000000.0);
        precios_area.put("Local comercial", 3000000.0);
        precios_area.put("Oficina", 3500000.0);
    }
