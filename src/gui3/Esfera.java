...
public class Esfera extends FiguraGeometrica{
    ...
    public Esfera(double radio) {
        this.radio = radio;
        this.setVolumen(this.calcularVolumen()); /* Calcula el volumen y
establece su atributo */
        this.setSuperficie(this.calcularSuperficie()); /* Calcula la superficie y
establece su atributo */
    }
    /**
    ...
    public double calcularVolumen() {
        double volumen = 4 * Math.PI * Math.pow(this.radio, 3.0)/3D;
        return volumen;
    }
    /**
